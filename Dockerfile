...
RUN wget -qO- https://binaries.cockroachdb.com/cockroach-v21.2.7.linux-amd64.tgz | tar  xvz
...
RUN go install github.com/rclone/rclone@v1.58.0
RUN go install github.com/rclone/rclone/fstest/test_all@v1.58.0
