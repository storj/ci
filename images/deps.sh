...
wget -qO- https://binaries.cockroachdb.com/cockroach-v23.1.14.linux-amd64.tgz | tar xvz
mv cockroach-v23.1.14.linux-amd64/cockroach /usr/local/bin/
mv cockroach-v23.1.14.linux-amd64/lib/* /usr/lib/
